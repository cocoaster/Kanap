    ...
    <div id="homeContent" >
      ...
      <img className="background" src={backgound} alt="background" />
        ...
        <div className="accordion" id="accordionAbout">
          <div className="accordion-item" id="aboutAccordionItem" >
            <h2 className="accordion-header">
              <button type="button " className="accordion-button  collapsed rounded d-block d-sm-none"   data-bs-toggle="collapse" data-bs-target="#fiability"  >Fiabilité</button></h2>
          ...
          <div className="accordion-item" id="aboutAccordionItem">
            <h2 className="accordion-header">
              <button type="button " className="accordion-button collapsed rounded d-block d-sm-none "  data-bs-toggle="collapse" data-bs-target="#respect"  >Respect</button></h2>
          ...
          <div className="accordion-item" id="aboutAccordionItem">
            <h2 className="accordion-header">
              <button type="button " className="accordion-button rounded d-block d-sm-none collapsed"   data-bs-toggle="collapse"  data-bs-target="#service" >Service</button></h2>
            <section className="accordion-body collapse" data-bs-parent="#accordionAbout"  id="service">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut lacinia vulputate imperdiet. Nullam nec lacus diam. Nullam egestas viverra vehicula. Interdum et malesuada fames ac ante ipsum primis in faucibus. Morbi ac eros vehicula, elementum nisi vitae, pretium elit. Etiam hendrerit auctor volutpat. Orci varius natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Quisque congue auctor tellus. Integer. </section> 
          </div>
       
          <div className="accordion-item" id="aboutAccordionItem">
            <h2 className="accordion-header">
              <button type="button " className="accordion-button rounded d-block d-sm-none collapsed"  data-bs-toggle="collapse" data-bs-target="#security"  >Sécurité</button></h2>
